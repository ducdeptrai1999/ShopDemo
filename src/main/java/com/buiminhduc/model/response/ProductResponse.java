...
public class ProductResponse {
    ...
    public ProductResponse(Integer id, String tenSanPham, String hinhAnh, String thongTinChiTiet, Integer giaBan, Integer soLuong, String mauSac, String tag, String trangThai, Integer idMenuCon) {
        this.id = id;
