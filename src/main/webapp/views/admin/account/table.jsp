    ...
    function deleteUser(data) {
        $.ajax({
            ...
            success: function (result) {
                window.location.href = "${Userurl}?type=list&page=1&maxPageItem=2&message=delete_success";
            },
            error: function (error) {
                window.location.href = "${Userurl}?type=list&page=1&maxPageItem=2&message=error_system";
            }
        });
    }
</script>
