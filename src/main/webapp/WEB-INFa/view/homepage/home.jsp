                ...
                <div class="row">
                    <div class="aa-popular-category-area">
                        ...
                        <%
                            ...
                            ResultSet rs1 = con1.chonDuLieuTuDTB("SELECT * FROM sanpham order by soLuong asc LIMIT 8");
                        %>
                        <div class="tab-content">
                    ...
                    <ul class="aa-testimonial-slider">
                        ...
                        <li>
                            <div class="aa-testimonial-single">
                                <img class="aa-testimonial-img" src="<c:url value="/templatesecond/img/yasuo.jpg"/>" alt="testimonial img">
