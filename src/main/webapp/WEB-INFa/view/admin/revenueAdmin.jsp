...
<%@ page import="com.buiminhduc.repository.dao.ObjectDAO" %>
<%@ page import="com.buiminhduc.util.ObjectUtil" %>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="checkout-area">
                    <form action="/admin/managerRevenue" method="post">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="checkout-left">
                                    <div class="panel-group" id="accordion">
                                        ...
                                        <div class="panel panel-default aa-checkout-billaddress">
                                            ...
                                            <%
                                                ResultSet until = new MySqlConnectionUtil().chonDuLieuTuDTB("select month(modefied_date), year(modefied_date) from donhang");
                                            %>
                                            <div id="collapseFour" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                            ...
                                                            <div class="aa-checkout-single-bill">
                                                                <select name="month">
                                                                    ...
                                                                    <%
                                                                        while (until.next()){
                                                                    %>
                                                                    <option value="<%=until.getString(1)%>"><%=until.getString(1)%></option>
                                                                    <%
                                                                        }
                                                                    %>
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="panel-body">
                                                                <input type="submit" value="Search" class="aa-browse-btn">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="aa-order-summary-area">
                                        <table class="table table-responsive">
                                            ...
                                            <%
                                                ...
                                                String sql = String.valueOf(servletContext.getAttribute("sql"));
                                                if (sql.equals("null")){
                                                    sql = "";
                                                }
                                                ...
                                                ResultSet rs = con.chonDuLieuTuDTB("select sum(TongTien) from donhang "+sql+"");
                                                ResultSet resultSet = new MySqlConnectionUtil().chonDuLieuTuDTB("select ListProduct, TongTien from donhang "+sql+"");
                                                if (rs==null || resultSet==null){

                                                }
                                                while (rs.next()){
                                                    tongThu = rs.getString(1);
                                                }
                                                ...
                                                int thue = Integer.parseInt(tongThu);
                                                thue = (int) (thue*(float)1/100);
                                                int total = Integer.parseInt(tongThu)- thue;
                                                Set<String> listSP = ObjectUtil.convertToString(name);
                                                ...
                                                for (String a: listSP) {
                                                    ...
                                                    String tempSP = a.substring(0,a.indexOf("&"));
                                                    String tempSl =a.substring(a.indexOf("&")+1);
                                                    sanpham.add(tempSP);
                                                    soluong.add(tempSl);
                                                }
                                            %>
                                            ...
                                            <tr>
                                                <td><%=sanpham.get(i)%></td>
                                                <td>x<strong><%=soluong.get(i)%></strong></td>
                                            </tr>
                                            <%
                                                }
                                            %>
                                            ...
                                            <tr>
                                                <th>Subtotal</th>
                                                <td><%out.print(tongThu);%></td>
                                            </tr>
                                            <tr>
                                                <th>Tax</th>
                                                <td><%out.print(thue);%></td>
                                            </tr>
                                            <tr>
                                                <th>Total</th>
