...
<%@ page import="com.buiminhduc.repository.ProductRepository" %>
            ...
            <div class="col-md-12">
                <div class="cart-view-area">
                    <div class="cart-view-table aa-wishlist-table">
                        ...
                        <form action="/admin/insertProduct" method="get">
                        <tr>
                            <div class="panel-body">
                                <input type="submit" value="Insert" class="aa-browse-btn">
                            </div>
                        </tr>
                        </form>
                        <form action="">
                            <div class="table-responsive">
                                <%
                                    ...
                                    List<ProductEntity> ds = product.findAll();
                                %>
                                <table class="table">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><a class="remove" href="/admin/deleteProduct?id=<%=ds.get(i).getId()%>"><fa class="fa fa-close"></fa></a></td>
                                        <td><%=ds.get(i).getId()%></td>
                                        <td><%=ds.get(i).getTenSanPham() %></td>
                                        <td><%=ds.get(i).getThongTinChiTiet() %></td>
                                        <td><%=ds.get(i).getGiaBan() %></td>
                                        <td><%=ds.get(i).getMauSac() %></td>
                                        <td><%=ds.get(i).getSoLuong() %></td>
                                        <td><a href="/admin/updateProduct?id=<%=ds.get(i).getId()%>" class="aa-add-to-cart-btn">Update</a></td>
