                    ...
                    <div class="cart-view-table aa-wishlist-table">
                        ...
                        <form action="">
                            <div class="table-responsive">
                                <%
                                    ArrayList<UserEntity> ds = new ThanhVienDAO().getDanhSach();
                                    ArrayList<UserEntity> dsLoc = (ArrayList<UserEntity>)session.getAttribute("dsLoc");
                                ...
                                <table class="table">
                                    <thead>
                                    <tr>
                                        <a href="insertacc.jsp" class="aa-add-to-cart-btn">Inser</a>
                                    </tr>
                                    <tr>
                                        <th>Id</th>
                                        <th>User Name</th>
                                    ...
                                    <tr>
                                        ...
                                        <td><%=ds.get(i).getPhone() %></td>
                                        <td><%=ds.get(i).getEmail() %></td>
                                        <td><a href="updateacc.jsp?id=<%=ds.get(i).getId()%>" class="aa-add-to-cart-btn">Update</a></td>
                                        <td><a href="/crudController?id=<%=ds.get(i).getId()%>" class="aa-add-to-cart-btn">Delete</a></td>
                                    </tr>
                                    <%} %>
                                    </tbody>
                                </table>
