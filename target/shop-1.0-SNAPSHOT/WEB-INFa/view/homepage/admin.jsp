                    ...
                    <div class="aa-header-top-area">
                        ...
                        <div class="aa-header-top-right">
                            <ul class="aa-head-top-nav-right">
                                ...
                                <li><a href="" data-toggle="modal" data-target="#login-modal">${MODEL.getUserName()}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="aa-header-bottom-area">
                        ...
                        <div class="aa-cartbox">
                            ...
                            <div class="aa-cartbox-summary">
                                <ul>
                                    <li>
                                        <a class="aa-cartbox-img" href="#"><img src="<c:url value="/template/web/img/woman-small-2.jpg"/>" alt="img"></a>
                                    ...
                                    <li>
                                        <a class="aa-cartbox-img" href="#"><img src="<c:url value="/template/web/img/woman-small-1.jpg"/>" alt="img"></a>
                                        <div class="aa-cartbox-info">
                                            <h4><a href="#">Product Name</a></h4>
                                            <p>1 x $250</p>
                                        </div>
        ...
        <div id="sequence" class="seq">
            <div class="seq-screen">
                <ul class="seq-canvas">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/template/web/img/slider/1.jpg"/>" alt="Men slide img" />
                        </div>
                        <div class="seq-title">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/template/web/img/slider/2.jpg"/>" alt="Wristwatch slide img" />
                        </div>
                        <div class="seq-title">
                    ...
                    <li>
                        <div class="seq-model">
                            <img data-seq src="<c:url value="/template/web/img/slider/3.jpg"/>" alt="Women Jeans slide img" />
                        </div>
                        <div class="seq-title">
                            <span data-seq>Save Up to 75% Off</span>
